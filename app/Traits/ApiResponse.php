...
trait ApiResponse
{
     ...
     * @return JsonResponse
     */
    public function sendError(string $message = null, ErrorCodeEnum $errorCode = null, int $statusCode = Response::HTTP_INTERNAL_SERVER_ERROR, array $errors = []): JsonResponse
    {
        $res = [
            'status' => false,
        ];
