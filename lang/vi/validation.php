...
return [
    ...
    'ascii' => 'Trường :attribute chỉ có thể chứa ký tự chữ cái và số dạng byte.',
    ...
    'between' => [
        ...
        'string' => 'Trường :attribute phải nằm trong khoảng từ :min đến :max ký tự.',
    ],
    ...
    'lt' => [
        'array' => 'Trường :attribute phảicó ít hơn :value phần tử.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Giá trị :attribute đã cho đã xuất hiện trong một rò rỉ dữ liệu. Vui lòng chọn một giá trị :attribute khác.',
    ],
    ...
    'url' => 'Trường :attribute không hợp lệ.',
